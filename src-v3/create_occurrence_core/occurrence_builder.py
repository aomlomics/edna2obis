    ...
    try:
        ...
        if all_processed_occurrence_dfs:
            ...
            try:
                ...
                reporter.add_text("The Occurrence Core at this step (before taxonomic mapping through WoRMS or GBIF), contains an assay_name column. This will be removed from the final Occurrence Core (after taxonomic mapping) but it is used by the taxonomic mapping code to know which assay's data you want to remove the 'species' rank from consideration. This is because some assays, like 16S for example, return non-usable assignments at species level, while, for example, 18S species assignments ARE useful.")
