"""
Column documentation and Excel I/O for taxa_alignment_INFO.
Output is taxa_alignment_INFO_<API>.xlsx with sheet taxa_alignment_INFO.
"""
...
SHEET_DATA = "taxa_alignment_INFO"
...
def write_taxa_assignment_info_xlsx(df: pd.DataFrame, xlsx_path: str) -> str:
    """Write .xlsx with sheet taxa_alignment_INFO. xlsx_path must end in .xlsx."""
